...
public interface CuentasPorCobrarRepository extends JpaRepository<CuentasPorCobrar, Long>, JpaSpecificationExecutor<CuentasPorCobrar> {
    ...
    Page<CuentasPorCobrar> obtenerTareasFiltro( @Param("bancos") List<String> bancos, @Param("vencimientos") List<String> vencimientos,
            @Param("sedes") List<String> sedes, @Param("juridicas") List<String> juridicas, @Param("diasStart") Integer diasStart, @Param("diasEnd") Integer diasEnd, @Param("idNombre") Long id,Pageable pageable);
